		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#brcomfortlevcadmaterialcadmaterial-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomfortlevcadmaterialcadmaterial-display": {
								"semanticObject": "brcomfortlevcadmaterialcadmaterial",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.fortlev.cadmaterial.cadmaterial",
									"url": sap.ui.require.toUrl("br/com/fortlev/cadmaterial/cadmaterial")
								}
							}
						}
					}
